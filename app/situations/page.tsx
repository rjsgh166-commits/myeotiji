...
const situations = [
  {
    ...
    steps: [
      ["1", "이직 마지노선", "/job-change", "실수령·근무시간·출퇴근까지 반영해 최소 제안 연봉 역산"],
      ["2", "연봉 A/B 비교", "/salary", "현재 연봉과 제안 연봉의 실제 월 실수령 차이"],
      ["3", "퇴직금", "/retirement", "근속기간과 최근 임금 기준 예상 퇴직금"],
      ["4", "연차", "/annual-leave", "남은 연차와 법정 발생일수 확인"],
      ["5", "실업급여", "/unemployment", "조건에 해당한다면 예상 지급액·기간 확인"],
    ],
  },
  {
    icon: "🧾",
